...
public class DataTransfer : MonoBehaviour
{
    ...
    public void pass_to_file()
    {
        ...
        if (DataManagement.gender == "Female")
            numberInput[0] = 0;
        else
            numberInput[1] = 1;
        ...
        string filePath = Path.Combine(UnityEngine.Application.dataPath, "T_Python", "numberInput.txt");
        using (StreamWriter writer = new StreamWriter(filePath))
        {
            UnityEngine.Debug.Log("Hey-hey!");
    ...
    public void load_class()
    {
        ...
        string filePath = Path.Combine(UnityEngine.Application.dataPath, "T_Python", "status_prediction.txt");
        ...
        if (File.Exists(filePath))
        {
            ...
            {
                UnityEngine.Debug.Log("Loaded prediction: " + prediction);
            ...
            {
                UnityEngine.Debug.LogError("Failed to parse prediction.");
            }
        }
        else
        {
             UnityEngine.Debug.LogError("Prediction file not found.");
        }
