...
public class MouseDraw : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    void Start()
    {
        ...
        ObjectBoundaries.Add(new ObjectBoundary(new Rect(585, 287, 165, 50), Color.red, 30));
        ObjectBoundaries.Add(new ObjectBoundary(new Rect(473, 318, 165, 50), Color.blue, -60));
    }
